...
const rawVideoBucketName = "nc142-yt-raw-videos";
const processedVideoBucketName = "nc142-yt-processed-videos";
...
export function convertVideo(rawVideoName: string, processedVideoName: string) {
    ...
    .outputOptions("-vf", "scale=-1:360") // Resize the video to 640x360
    .on("end", () => {
